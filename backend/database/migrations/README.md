...
| 004 | [`004_add_gps_coordinates.sql`](004_add_gps_coordinates.sql) | Adds optional `latitude`/`longitude` columns (range-checked) for the report form's "tag my location" button. |
